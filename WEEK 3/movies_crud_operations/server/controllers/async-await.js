...
MongoClient.connect(url, function (err, client) {
    ...
    dbase.collection(collName).insertMany(myobj, function (err, res) {
        ...
        // dbase.collection(collName).find(query).toArray(async function (err, result) {
        //     // if (err) throw err;
        //     try { result.forEach(element => console.table(element)); } catch (err) {
        //         console.error(err);
        //     }
        ...
        //             dbase.collection(collName).updateOne(myQuery, newValues, function (err, res) {
        //                 if (err) throw err;
        ...
        //         result.forEach(element => {
        //             var myQuery = { movieName: element.movieName };
        //             dbase.collection(collName).deleteOne(myQuery, function (err, obj) {
        //                 if (err) throw err;
